...
//    public BindingItemsListController missingBindingsListController;
...
//        missingBindingsListController = go.AddComponent<BindingItemsListController>();
...
//        missingBindingsListController.bindings = bindingsState;
...
//        // ----------------- Act ------------------------
//        missingBindingsListController.FindMissingBindings();

//        // ----------------- Assert ------------------------
//        // Should only be missing the HeadLookPitchDown because all of the others have a binding
//        Assert.AreEqual(1, missingBindingsListController.missingHolographicBindings.Count);
